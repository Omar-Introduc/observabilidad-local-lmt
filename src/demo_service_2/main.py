...
app = FastAPI()
adapter = TelemetryAdapter(service_name="demo_service_2")

@app.get("/")
def home():
    """
    Root of the demo service 2
    """
    return {"message": "Demo Service 2"}

@app.get("/log")
def send_log():
    adapter.log("INFO", "This is a test log from Demo Service 2")
